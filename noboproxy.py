...
def update():
    ...
    if mode == 'comfort':
      hub.create_override(hub.API.OVERRIDE_MODE_COMFORT, hub.API.OVERRIDE_TYPE_CONSTANT, zoneId)
    else:
      hub.create_override(hub.API.OVERRIDE_MODE_ECO, hub.API.OVERRIDE_TYPE_CONSTANT, zoneId)
    return '', 204
